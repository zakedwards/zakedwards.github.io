/**
 * An interface written for a 'robot-maze' game environment, wherein data structures are utilised to
 * iteratively optimise in-game mechanics and strategic gameplay (maximising offensive efforts and
 * minimising received damage).
 *
 *
 * @author:  Zak Edwards
 * @version: 1.0
